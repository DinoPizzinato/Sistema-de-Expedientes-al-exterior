document.addEventListener("DOMContentLoaded", () => {
  ...
  const BURBUJA_ADUANA_STORAGE_KEY = "extradicionesBurbujaAduanaPos";
  ...
  btnGenerarWord.addEventListener("click", () => {
    ...
    console.log("Datos de extradiciones reunidos para Word:", datos);

    try {
      if (!window.ExtradicionesWord?.generarDocumentos) {
        throw new Error("No se pudo inicializar el generador de Word.");
      }

      const archivos = window.ExtradicionesWord.generarDocumentos(datos);
      mostrarAviso(
